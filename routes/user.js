...
const { getUserById, getSize, getUser, updateUser, userPurchaseList, userOrderList, pushOrderInCartList, userCartList, deleteItemFromCart, updateCart, checkPassword } = require("../controllers/user");
...
router.put("/user/:userId", isSignedIn, isAuthenticated, checkPassword, updateUser)
